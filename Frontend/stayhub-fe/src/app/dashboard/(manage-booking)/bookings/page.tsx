...
import { CloseCircleOutlined, CalendarOutlined, HomeOutlined, EditOutlined, DeleteOutlined, PlusCircleOutlined } from "@ant-design/icons";
...
export default function BookingView() {
    ...
    const handleCancelRoom = async (room: any, onSuccess: () => Promise<void>) => {
        Modal.confirm({
            ...
            onOk: async () => {
                try {
                    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/employee/bookings/rooms/edit/${room.id}`, {
                        method: "PATCH",
    ...
    const handleDeleteRoom = async (room: any, onSuccess: () => Promise<void>) => {
        Modal.confirm({
            ...
            onOk: async () => {
                try {
                    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/employee/bookings/rooms/delete/${room.id}`, {
                        method: "DELETE",
                        credentials: "include"
                    });
                    if (res.ok) {
    ...
    const expandedRoomColumns = (onSuccess: () => Promise<void>, onEdit: (room: any) => void) => [
...
const confirmCancel = async () => {
    ...
    try {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/employee/bookings/cancel/${recordToCancel.id}`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            credentials: "include"
        });
