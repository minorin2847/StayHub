    ...
    <div className="flex flex-col w-full">
      <div className="px-[30px] pt-[30px]">
        ...
        <div className="grid grid-cols-3 gap-6 mb-[10px]">
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">Active Terms</p>
              <h2 className="text-3xl font-bold text-gray-800">{stats.activeTerms}</h2>
            </div>
            <div className="w-12 h-12 bg-blue-50 text-blue-500 rounded-full flex justify-center items-center text-xl">
              <BsShieldCheck />
            </div>
          </div>
        ...
        tableColumns={[
          {
            ...
            render: (text) => (
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-blue-50 text-blue-500 flex justify-center items-center"><BsCardChecklist /></div>
                <span>{text}</span>
              </div>
            )
          },
