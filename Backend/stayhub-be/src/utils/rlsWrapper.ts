    ...
    return db.tx(transactionName, async (t) => {
        ...
        .catch((err) => {
            if (err instanceof Error) {
                ...
                console.error(`There's an unknown error in ${transactionName}!`);
            }
            throw err;
        });
}