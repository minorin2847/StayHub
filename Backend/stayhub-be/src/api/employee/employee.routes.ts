...
import { changeEmployeePassword, createEmployee, deleteEmployee, editEmployee, getEmployee, login, logout } from "./employee.handler.js";
...
employeeRoute.post("/changepassword", isLoggedIn, changeEmployeePassword);
